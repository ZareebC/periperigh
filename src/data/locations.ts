...
export const locations: Location[] = [
  ...
  },
  {
    ...
    orderLinks: [
      {
        platform: 'UberEats',
        url: 'https://www.ubereats.com/store/peri-peri-grill-house-bethpage/BnzRib2TWzaq7i7oAPw6Tw',
      },
      {
        platform: 'DoorDash',
        url: 'https://www.doordash.com/store/peri-peri-grill-house-bethpage-36761897/',
      },
    ],
    metaDescription:
